...
namespace Debugging
{
    class Program
    {
        ...
        static void MainMenu()
        {
            ...
            System.Console.WriteLine("Welcome to Syncfusion College of Engineering and Technology");  //26
            do
            {
            ...
            } while (mainChoice == "yes"); //Maintaing the mainmenu looping until user chose to exit         //14
        ...
        static void StudentRegistration()
        {
            ...
            //Physics Mark
            int physics;
            bool tempPhysics = int.TryParse(Console.ReadLine(), out physics);   //1
            while (!tempPhysics)                                                                     //25
            {
            ...
            {
                System.Console.WriteLine("Invalid Input. Enter a Valid Mark.");
                tempMaths = int.TryParse(Console.ReadLine(), out maths);            //2
            }
            ...
            if (studentID != null) //checking whether the input is null or not
            {
                ...
                foreach (StudentDetails student in studentList)
                {
                    if (student.StudentID == studentID)
                    {
                        ...
                        currentLoggedInStudent = student;           //3
                        //calling Submenu
                        SubMenu();
                        break;
                    }
        ...
        static void SubMenu()
        {
            ...
            System.Console.WriteLine($"Welcome {currentLoggedInStudent.StudentName} to Student's Portal");      //26
            do
            {
                System.Console.WriteLine(line);
                System.Console.WriteLine(line);
            ...
            } while (subChoice == "yes"); //Maintaing the submenu looping until user chose to exit      //13
        }//SubMenu Method Ends
        ...
        static void CheckEligibility()
        {
            ...
            bool eligibility = currentLoggedInStudent.CheckEligibility(75.0);       //4
                        ...
                        if (eligibilty) //If Eligible
                        {
                            if (department.NumberOfSeats > 0) //Checking seat availabilty
                            {
                                ...
                                if (count == 0) //If no admission is taken previously
                                {
                                    ...
                                    admissionList.Add(newAdmission);       //12
        ...
        static void CancelAdmission()
        {
            ...
            if (!flag)
            {
                System.Console.WriteLine("AdmissionID StudentID DepartmentID AdmissionDate AdmissionStatus");       //30
                System.Console.WriteLine(line);
                foreach (AdmissionDetails admission in admissionList)
                {
                    //Checking if the student has admission already
        ...
        static void ShowAdmissionDetails()
        {
            ...
            if (!flag)
            {
                System.Console.WriteLine("AdmissionID StudentID DepartmentID AdmissionDate AdmissionStatus");       //32
                System.Console.WriteLine(line);
                foreach (AdmissionDetails admission in admissionList)
                {
                    //Checking if the student's admission details
