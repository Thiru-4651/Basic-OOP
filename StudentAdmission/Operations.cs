...
namespace StudentAdmission
{
    ...
    public static class Operations
    {
        ...
        public static void ShowDetails()
        {
            ...
            System.Console.WriteLine($"|{currentLoggedInStudent.StudentID}\t||{currentLoggedInStudent.StudentName}\t||{currentLoggedInStudent.FatherName}\t||{currentLoggedInStudent.DOB}\t||{currentLoggedInStudent.Gender}\t||{currentLoggedInStudent.Physics}\t||{currentLoggedInStudent.Chemistry}\t||{currentLoggedInStudent.Maths}\t|");
        }//Show Details ends
